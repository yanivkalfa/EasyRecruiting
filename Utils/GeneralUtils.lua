EasyRecruiting.Utils.General = {};


function EasyRecruiting.Utils.General.randomString(len)
  local str, letterList;
  len = len or 25;
  local str = "";
  letterList = EasyRecruiting.Constants.LETTER_LIST;
  for i = 1, len do
...
function EasyRecruiting.Utils.General.getFullPlayerName()
...
local function filterPrefixedMessages(msg)
  return string.find(msg, EasyRecruiting.Constants.MSG_PREFIX);
end
...
function EasyRecruiting.Utils.General.hidePrefixedMessages()
...
function EasyRecruiting.Utils.General.log(msg, channel)
  DEFAULT_CHAT_FRAME:AddMessage(msg);
  return;
end

function EasyRecruiting.Utils.General.implode(delimiter, list)
...
function EasyRecruiting.Utils.General.explode(delimiter, text)
